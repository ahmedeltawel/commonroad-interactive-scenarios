...
Extend the exists static cr_scenario generation methods to interative scenarios.
...
Overload some methods to reserve only the initial states for interaction and extend the scenario benchmark Ids with mark **I**.
